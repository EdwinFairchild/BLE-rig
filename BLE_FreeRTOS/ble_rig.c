...
void vTask1(void *pvParameters)
{
    ...
    while (1) {
        ...
        APP_TRACE_INFO3("ME14: %d\r\nME17: %d \r\nME18: %d", (notificationValue&0x01),(notificationValue&0x02),(notificationValue&0x03));
...
void freeRTOS_init(void)
{
    ...
    //start tasks
     if (xTaskCreate(vTask1, (const char *)"Task1", configMINIMAL_STACK_SIZE, NULL,tskIDLE_PRIORITY + 1, &vTask1_hdl) != pdPASS)
    {
